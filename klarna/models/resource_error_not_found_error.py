...
class ResourceErrorNotFoundError(object):
    """Implementation of the 'ResourceErrorNotFoundError' model.

    The requested resource was not found.

    Attributes:
        error_id (uuid|str): Unique error identifier
        error_code (ErrorCode5): Error code within the error type
    ...
    def __init__(
        ...
        """Initialize a ResourceErrorNotFoundError instance."""
