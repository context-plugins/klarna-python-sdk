...
class InputErrorContentTypeError(object):
    """Implementation of the 'InputErrorContentTypeError' model.

    The input does not conform to the expected content type syntax. For example
    invalid JSON.
