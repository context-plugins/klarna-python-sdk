...
class InputErrorValidationError(object):
    """Implementation of the 'InputErrorValidationError' model.

    An input parameter failed input validation. For example exceeding a max value, or
    ...
    Attributes:
        ...
        validation_errors (List[ParameterError]): A list of validation errors that
            occurred
    ...
    def __init__(
        ...
        if validation_errors is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("validation_errors") is not None:
            validation_errors = [
                ParameterError.from_dictionary(x)
                    for x in dictionary.get("validation_errors")
            ]
        else:
            validation_errors = APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"validation_errors={_validation_errors!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"validation_errors={_validation_errors!s}, "
