...
class AccessErrorRateLimited(object):
    """Implementation of the 'AccessErrorRateLimited' model.
    ...
    Attributes:
        ...
        error_code (ErrorCode6): Error code within the error type
    ...
    def __init__(
        ...
        """Initialize a AccessErrorRateLimited instance."""
