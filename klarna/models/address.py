...
class Address(object):
    ...
    Attributes:
        attention (str): 'Attn.' - optional parameter.
        city (str): City.
        country (str): Country. ISO 3166 alpha-2.
        ...
        postal_code (str): Postcode. Validation according to [Universal Postal Union
            addressing
            system](https://www.upu.int/en/activities/addressing/postal-addressing-sys
            tems-in-member-countries.html).
        region (str): State/Region. Required for US.
        street_address (str): First line of street address. Validation according to
            [Universal Postal Union addressing
            system](https://www.upu.int/en/activities/addressing/postal-addressing-sys
            tems-in-member-countries.html)
        street_address_2 (str): Second line of street address.
        title (str): Title.
