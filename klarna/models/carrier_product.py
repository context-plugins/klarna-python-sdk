...
class CarrierProduct(object):
    """Implementation of the 'CarrierProduct' model.

    The chosen timeslot of the selected shipping option

    Attributes:
        identifier (str): Id of carrier product
        name (str): Name of carrier product
    ...
    def __init__(
        ...
        """Initialize a CarrierProduct instance."""
