...
from klarna.logging.configuration.api_logging_configuration import (
...
class Environment(Enum):
    ...
    # EU Production API host
    PRODUCTION = 0
    # EU Playground API host
    ENVIRONMENT2 = 1
...
class Configuration(HttpClientConfiguration):
    ...
    @property
    def klarna_api_key_credentials(self):
        """Return current klarna_api_key_credentials."""
        return self._klarna_api_key_credentials
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, klarna_api_key_credentials=None,
        ...
        self._klarna_api_key_credentials = klarna_api_key_credentials
    ...
    def clone_with(self, http_client_instance=None,
        ...
        klarna_api_key_credentials =\
            (klarna_api_key_credentials
            or self.klarna_api_key_credentials)
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://api.klarna.com",
            Server.DEFAULT1: "https://api.klarna.com/settlements/v1",
        },
        Environment.ENVIRONMENT2: {
            Server.DEFAULT: "https://api.playground.klarna.com",
            Server.DEFAULT1: "https://api.klarna.com/settlements/v1",
        },
    }
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            klarna_api_key_credentials=KlarnaApiKeyCredentials.from_environment(),
