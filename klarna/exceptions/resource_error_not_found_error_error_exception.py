...
class ResourceErrorNotFoundErrorErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ResourceErrorNotFoundErrorErrorException object.
        ...
        """
        super(ResourceErrorNotFoundErrorErrorException,
