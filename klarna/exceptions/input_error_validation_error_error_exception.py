...
class InputErrorValidationErrorErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize InputErrorValidationErrorErrorException object.
        ...
        """
        super(InputErrorValidationErrorErrorException, self).__init__(reason, response)
