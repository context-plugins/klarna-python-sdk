...
class AccessErrorRateLimitedErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AccessErrorRateLimitedErrorException object.
        ...
        """
        super(AccessErrorRateLimitedErrorException, self).__init__(reason, response)
