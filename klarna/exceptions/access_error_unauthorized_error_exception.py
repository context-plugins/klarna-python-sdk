...
class AccessErrorUnauthorizedErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AccessErrorUnauthorizedErrorException object.
        ...
        """
        super(AccessErrorUnauthorizedErrorException, self).__init__(reason, response)
