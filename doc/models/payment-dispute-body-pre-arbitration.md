...
# Payment Dispute Body Pre Arbitration
...
| `state_context` | [`StateContext2`](../../doc/models/state-context-2.md) | Required | Additional context specific to the current dispute state. Required in all states, with different schemas depending on the state. |
...
from klarna.models.payment_dispute_body_pre_arbitration import PaymentDisputeBodyPreArbitration
...
payment_dispute_body_pre_arbitration = PaymentDisputeBodyPreArbitration(
