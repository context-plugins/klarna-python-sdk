...
# Payment Dispute Body Closed

The dispute has been closed and a final decision has been made.
...
| `state_context` | [`StateContext3`](../../doc/models/state-context-3.md) | Required | Additional context specific to the current dispute state. Required in all states, with different schemas depending on the state. |
...
| `arbitration` | [`PaymentDisputeArbitrationDetailsBase`](../../doc/models/payment-dispute-arbitration-details-base.md) | Required | Details specific to the arbitration process |
...
from klarna.models.payment_dispute_body_closed import PaymentDisputeBodyClosed
...
payment_dispute_body_closed = PaymentDisputeBodyClosed(
