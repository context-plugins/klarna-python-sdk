...
| `auto_capture` | `bool` | Optional | Allow merchant to trigger auto capturing.<br><br>**Default**: `False` |
...
from klarna.models.create_order_request import CreateOrderRequest
