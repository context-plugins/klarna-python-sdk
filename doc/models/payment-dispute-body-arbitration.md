...
# Payment Dispute Body Arbitration
...
| `state_context` | `Any` | Optional | Additional context specific to the current dispute state. Required in all states, with different schemas depending on the state. |
...
from klarna.models.payment_dispute_body_arbitration import PaymentDisputeBodyArbitration
...
payment_dispute_body_arbitration = PaymentDisputeBodyArbitration(
    ...
    state_context=jsonpickle.decode('{"key1":"val1","key2":"val2"}'),
    process_exceptions=[
