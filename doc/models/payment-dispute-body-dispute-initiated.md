...
# Payment Dispute Body Dispute Initiated
...
| `state_context` | [`StateContext`](../../doc/models/state-context.md) | Required | Additional context specific to the current dispute state. Required in all states, with different schemas depending on the state. |
...
payment_dispute_body_dispute_initiated = PaymentDisputeBodyDisputeInitiated(
