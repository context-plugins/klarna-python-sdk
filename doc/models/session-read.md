...
| `customer` | [`CustomerRead`](../../doc/models/customer-read.md) | Optional | Object to provide the details of the customer making the payment. |
...
session_read = SessionRead(
    ...
    authorization_token='authorization_token6',
