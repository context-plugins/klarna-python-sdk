...
`PRE_ARBITRATION` - Pre-arbitration phase. Preliminary decision made. Partner has opportunity to accept the decision or escalate to arbitration.
...
from klarna.models.payment_dispute_state_change_pre_arbitration import PaymentDisputeStateChangePreArbitration

payment_dispute_state_change_pre_arbitration = PaymentDisputeStateChangePreArbitration(
