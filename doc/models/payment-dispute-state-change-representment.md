...
`REPRESENTMENT` - Partner evidence review phase. Partner has submitted evidence and Klarna is reviewing the representment case.
...
| `partner_evidence` | [`PaymentDisputePartnerEvidence`](../../doc/models/payment-dispute-partner-evidence.md) | Optional | Partner representment responses |
...
from klarna.models.payment_dispute_state_change_representment import PaymentDisputeStateChangeRepresentment

payment_dispute_state_change_representment = PaymentDisputeStateChangeRepresentment(
