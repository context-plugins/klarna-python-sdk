...
`ARBITRATION` - Arbitration phase. Final review by Klarna.
...
| `arbitration_request` | [`PaymentDisputeArbitrationRequest`](../../doc/models/payment-dispute-arbitration-request.md) | Required | Captures the Partner's appeal against a preliminary arbitration decision, including the written explanation and any supporting evidence files. |
...
from klarna.models.payment_dispute_state_change_arbitration import PaymentDisputeStateChangeArbitration

payment_dispute_state_change_arbitration = PaymentDisputeStateChangeArbitration(
