...
| `order_amount` | `int` | Required | Total amount of the order including tax and any available discounts. The value should be in non-negative minor units. Eg: 25 Euros should be 2500.<br><br>**Constraints**: `>= 0` |
| `order_lines` | [`List[OrderLine1]`](../../doc/models/order-line-1.md) | Required | The array containing list of line items that are part of this order. Maximum of 1000 line items could be processed in a single order.<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `1000` |
